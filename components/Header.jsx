...
export default function Header() {
  ...
  return (
    <header aria-label="Site Header" className={theme}>
      <div className="flex items-center h-16 gap-8 px-6 mx-auto shadow-sm sm:px-8 lg:px-12 dark:border-b dark:border-gray-800">
        <Link
        ...
        <div className="flex items-center justify-end flex-1 md:justify-between">
          <nav
            aria-label="Site Nav"
            className="justify-end hidden w-full md:flex"
          >
  ...
  return (
    <li>
      <Link
        ...
        } transition dark:text-gray-200 dark:hover:text-gray-200/75  text-gray-500 hover:text-gray-500/75`}
        href={path}
      >
        {name}
      </Link>
